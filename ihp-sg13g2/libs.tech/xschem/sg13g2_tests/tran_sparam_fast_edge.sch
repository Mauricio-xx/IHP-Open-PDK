...
* VF Transient: Fast edge (50ps rise) stress test
* Tests VF with wideband content (rise ~50ps => BW ~7GHz)
* The RC lowpass (3dB at 1.17GHz) should filter this
* Expected: output is smoothed, peak less than input
}
G {}
K {}
V {}
...
sim_type=tran
autoload=1}
T {VF S-Parameter Transient Test: Fast Edge} 50 -720 0 0 0.4 0.4 {}
T {50ps rise time pulse through RC lowpass VF model.} 50 -680 0 0 0.25 0.25 {layer=8}
T {Wideband stress: BW ~7 GHz vs 3dB at 1.17 GHz.} 50 -660 0 0 0.25 0.25 {layer=8}
N 200 -400 200 -370 {
lab=GND}
N 200 -500 200 -460 {
lab=in}
...
.control
run
write tran_sparam_fast_edge.raw
.endc
"}
C {devices/vsource.sym} 200 -430 0 0 {name=V1 value="PULSE(0 1 0.5n 0.05n 0.05n 2n 10n)"}
