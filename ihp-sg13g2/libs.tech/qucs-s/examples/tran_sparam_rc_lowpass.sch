...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=tran_sparam_rc_lowpass.dat>
  <DataDisplay=tran_sparam_rc_lowpass.dpl>
  <OpenDisplay=0>
  <Script=tran_sparam_rc_lowpass.m>
  <RunScript=0>
  <showFrame=3>
  <FrameText0=VF S-Parameter Transient: RC Lowpass>
...
<Components>
  <Vac V1 1 160 700 18 -26 0 1 "1 V" 1 "0" 0 "0" 0 "0" 0>
  ...
  <Vpulse V2 1 160 700 18 -26 0 1 "0 V" 1 "1 V" 1 "1 ns" 1 "0.1 ns" 1 "0.1 ns" 1 "5 ns" 1 "20 ns" 1 "0" 0>
  <Lib S1 1 420 640 50 -26 0 0 "$HOME/<qucs_workspace>/user_lib/IHP_PDK_sparam_vf" 0 "sparam_2port" 0 "rc_lowpass.s2p" 1 "50" 1 "0" 1 "1e-3" 1 "10" 1>
</Components>
<Wires>
...
<Diagrams>
  <Rect 700 850 500 400 3 #c0c0c0 1 00 1 0 1e-8 4e-8 1 -0.1 0.2 0.6 1 -1 0.2 1 315 0 225 1 0 0 "" "" "">
